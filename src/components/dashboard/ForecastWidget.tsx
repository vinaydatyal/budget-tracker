...
import { startOfMonth, subDays, isAfter, addMonths, format } from 'date-fns';
...
export function ForecastWidget({ transactions: rawTransactions, accounts: rawAccounts, isBusinessMode = false }: Props) {
  const { state } = useApp();
